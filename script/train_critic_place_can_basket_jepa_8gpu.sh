...
CONFIG="${CONFIG:-wan_va/rl_configs/qgf_phase1_robotwin_place_can_basket_200rollout_50success_jepa.json}"
...
LOG_RANK="${LOG_RANK:-0}"
LOG_DIR="${LOG_DIR:-training_logs/critic_place_can_basket_jepa}"
